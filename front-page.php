...
<?php get_header(); ?>
        ...
        <div class="blog-regular mt-5">
            ...
            <div class="row mx-5">
            <?php 
            // Configurar la consulta de publicaciones para mostrar 8 posts en la portada
            $args = array(
                'posts_per_page' => 8, // Número de posts a mostrar en la home
        ...
        <div class="bolg-metro my-5 mx-5">
            ...
            <div class="row">
                ...
                <div class="blog col-12 col-sm-12 col-md-6 col-lg-4 mt-5">
                    <div class="position-relative">
                        <!-- Imagen destacada -->
                        <?php if (has_post_thumbnail()) : ?>
                            <img src="<?php the_post_thumbnail_url('large'); ?>" class="img-fluid img-row" alt="<?php the_title(); ?>">
